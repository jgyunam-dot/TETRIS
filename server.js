...
const server=http.createServer((req,res)=>{
  ...
  let filename;
  if(urlPath==='/'||urlPath===''||urlPath==='/tetris'||urlPath==='/tetris.html') filename='tetris.html';
  else if(urlPath==='/bingo'||urlPath==='/bingo.html')   filename='bingo.html';
  else if(urlPath==='/menu'||urlPath==='/index'||urlPath==='/index.html') filename='index.html';
  else                                            filename='tetris.html';
